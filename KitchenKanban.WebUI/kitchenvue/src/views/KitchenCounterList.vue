          ...
          <tbody>
            ...
            >
              ...
              <td class="text-center">
                <button
                  class="trans-btn"
                  @click="deleteCounter(data.counterId)"
                >
...
export default {
  ...
  methods: {
    ...
    addKCounter: function() {
      ...
      KitchenCounterService.post(this.CounterNumber)
        .then((response) => {
    ...
    updateKCounter: function() {
      ...
      KitchenCounterService.patch(this.CounterNumber)
        .then((response) => {
          this.clearKCounter(),
    ...
    deleteCounter: function(counterid) {
      KitchenCounterService.delete(counterid)
        .then((response) => {
